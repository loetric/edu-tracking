...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row overflow-x-hidden h-screen print:block print:h-auto print:min-h-0" dir="rtl">
      {/* Mobile Header */}
      <div className="md:hidden bg-white p-2 shadow-sm border-b border-gray-100 flex justify-between items-center sticky top-0 z-30 print:hidden">
      ...
      {/* Main Content Area */}
      <main className={`flex-1 p-2 md:p-4 lg:p-8 transition-all duration-300 print:p-4 print:w-full print:max-w-full print:overflow-visible w-full max-w-[100vw] overflow-x-hidden overflow-y-auto ${isSidebarCollapsed ? 'md:mr-20' : 'md:mr-64'}`}>
